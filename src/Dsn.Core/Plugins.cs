...
public sealed class PluginLoader
{
    ...
    public void Load(string path, DsnRuntime runtime, WorkspaceServices services, bool required = true)
    {
        try
        {
            ...
            foreach (var type in types)
            {
                ...
                if (!runtime.Register(plugin.Create(services)) && required) throw new InvalidOperationException("Required plugin registration rejected");
            }
        }
